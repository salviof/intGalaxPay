 ...
 * @author salvio
 */
public class IntegracaoRestIntgalaxpayAssinaturasDoClienteCriarCobrancaSazonalTest {

    public IntegracaoRestIntgalaxpayAssinaturasDoClienteCriarCobrancaSazonalTest() {
    }

    /**
     * Test of gerarCorpoRequisicao method, of class
     * IntegracaoRestIntgalaxpayAssinaturasDoClienteCriarCobrancaSazonal.
     */
}

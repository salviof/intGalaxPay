 ...
 * @author salvio
 */
public class IntegracaoRestIntgalaxpayPlanoEditarTest {

    @Test
    public void testSomeMethod() {
        SBCore.configurar(new ConfiguradorCoreApiGalaxPay(), SBCore.ESTADO_APP.DESENVOLVIMENTO);
        FabApiRestIntGalaxPayPlanos.PLANO_EDITAR.getGestaoToken().getComoTokenDinamico();
        FabApiRestIntGalaxPayPlanos.PLANO_EDITAR.getGestaoToken();
        ItfAcaoApiRest acao = FabApiRestIntGalaxPayPlanos.PLANO_EDITAR.getAcao(1, "plano testes 2", 12, 130.5);

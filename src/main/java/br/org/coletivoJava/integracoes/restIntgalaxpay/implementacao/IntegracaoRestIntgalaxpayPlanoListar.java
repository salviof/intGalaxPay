...
@InfoIntegracaoRestIntgalaxpayPlanos(tipo = FabApiRestIntGalaxPayPlanos.PLANO_LISTAR)
public class IntegracaoRestIntgalaxpayPlanoListar
        extends
        AcaoApiIntegracaoAbstrato {

    public IntegracaoRestIntgalaxpayPlanoListar(
            final FabTipoAgenteClienteApi pTipoAgente,
            final ComoUsuario pUsuario, final java.lang.Object... pParametro) {
        super(FabApiRestIntGalaxPayPlanos.PLANO_LISTAR, pTipoAgente, pUsuario,
                pParametro);
    }
